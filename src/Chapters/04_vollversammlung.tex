...
\label{subsec:para:26}
Innerhalb der Studierendenschaft können Studierendenbefragungen oder Vollversammlungen der Studierendenschaft zu Belangen nach \cref{subsec:para:1} durchgeführt werden, die der Meinungsbildung dienen.

\subsection{Vollversammlung}
\label{subsec:vollversammlung}
\label{subsec:para:27}
\begin{enumerate}[label=(\arabic*)]
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \item auf Antrag einer Zweidrittelmehrheit der Mitglieder des Studierendenparlaments,
