% !TEX root = ../Main.tex
% ==============================================================================
% Fünfter Abschnitt: Geld und Vermögensangelegenheiten
% ==============================================================================

\newpage
\setcounter{chapter}{5}
\chapter*{Fünfter Abschnitt: Geld und Vermögensangelegenheiten}
\addcontentsline{toc}{chapter}{Geld und Vermögensangelegenheiten}
\chaptermark{Geld und Vermögensangelegenheiten}
\vspace*{-1.5em}
\rule{\textwidth}{0.5mm}
\vspace*{-2em}
...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item Die Studierendenschaft bestreitet die Ausgaben für ihre satzungsgemäßen Aufgaben aus den Beiträgen der Studierenden, aus Zuwendungen Dritter und aus sonstigen Einnahmen. Die Höhe der Beiträge ist für das neue Haushaltsjahr gleichzeitig mit der Feststellung des Haushaltsplanes durch die Beitragssatzung (§ 31) festzusetzen. Sie ist vom Präsidium der Hochschule zu genehmigen, der spätestens einen Monat vor Beginn des Haushaltsjahres über die Festsetzung zu informieren ist.
...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item Die Mitglieder in den Organen der Studierendenschaft üben ihre Tätigkeit ehrenamtlich aus. Das Studierendenparlament kann für die Mitglieder des Allgemeinen Studierendenausschusses sowie für die Mitglieder des Studierendenparlaments eine angemessene Aufwandsentschädigung festsetzen.
\end{enumerate}
