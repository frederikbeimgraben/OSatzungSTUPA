...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item Einsetzen von Arbeitskreisen,
...
\begin{enumerate}[label=(\arabic*)]
  \item Wird ein Mitglied doppelt in des Studierendenparlament gewählt, so rückt die Person mit der nächsthöheren Stimmanzahl in der jeweiligen Wahl nach. Ist dies nicht möglich, so bleibt der Sitz unbelegt.
  \item Jedes Mitglied hat eine Stimme. \cref{subsec:allg:beschlussfassung} Absatz 1 bleibt davon unberührt.
  \item \hl{Die Übertragung der Stimme von einem studentischen Entsandten eines Fakultätsrates auf eine der benannten Vertretungen desselben Fakultätsrates bedarf abweichend von} \cref{subsec:allg:beschlussfassung} Absatz 1 \hl{keiner Mitteilung an den Vorsitzenden des Studierendenparlamentes.}
\end{enumerate}
...
\begin{enumerate}[label=(\arabic*)]
  \item Scheidet ein von den studentischen Fakultätsräten entsandtes Mitglied des Studierendenparlamentes aus, so rückt ein Mitglied des jeweiligen studentischen Fakultätsrats als ständiges Mitglied nach. Die studentischen Fakultätsräte einer jeder Fakultät haben im Weiteren für den Bestand von zwei Ersatzmitgliedern Sorge zu tragen.
  \item Ein von den studentischen Fakultätsräten entsandtes Mitglied des Studierendenparlamentes scheidet aus dem STUPA aus
  \begin{enumerate}[label=\alph*)]
    ...
    \item \hl{durch wiederholtes unentschuldigtes Fehlen bei ordentlichen Sitzungen. Näheres regelt die Geschäftsordnung (GO) des STUPAs,}
    \item \hl{durch Tod.}
  \end{enumerate}
...
\section*{Zweiter Unterabschnitt: Arbeitskreise des Studierendenparlamentes}
\addcontentsline{toc}{section}{\textbf{Arbeitskreise des Studierendenparlamentes}}
\sectionmark{Arbeitskreise des Studierendenparlamentes}
\label{sec:referate}

\subsection{\hl{Arbeitskreise}}
\label{subsec:stupa:referate}
\begin{enumerate}[label=(\arabic*)]
  \item Das STUPA kann \hl{Arbeitskreise} einsetzen, die dem Studierendenparlament \hl{gegenüber} für ihre Tätigkeit verantwortlich sind.

  \item \hl{Das STUPA wählt mindestens ein mal im Jahr, auf Forderung von mindestens 20 \% der anwesenden Mitglieder des STUPAs oder auf Forderung des Vorsitzenden, für jeden Arbeitskreis eine Arbeitskreisleitung entsprechend}\relax~\cref{subsec:allg:wahlen}. \hl{Eine Arbeitskreisleitung besteht aus einem Vorsitzenden und höchstens zwei weiteren Mitgliedern. Alle Mitglieder haben eine Stimme im jeweiligen Arbeitskreis.}

  \item Der \hl{Arbeitskreisleitung} können \hl{Mitglieder und Nichtmitglieder} des STUPA mit Sitz und Stimme angehören. \hl{Für die Mitgliedschaft gilt entsprechend} \cref{subsec:allg:mitgliedschaft_mitwirkung} Absatz 4. Der Vorsitzende der \hl{Arbeitskreisleitung} soll dem Studierendenparlament angehören.

  \item \hl{Mitglieder der Arbeitskreisleitung müssen Mitglieder der Studierendenschaft im Sinne von} \cref{subsec:allg:aufgaben} \hl{sein.}

  \item \hl{Als ständige Arbeitskreise werden eingerichtet}
  \begin{enumerate}[label=\arabic*.]
    \item der Arbeitskreis Finanzen, dessen Vorsitz kraft seines Amtes der Finanzreferent übernimmt. Aufgabe ist es, die Finanzen der Studierendenschaft, sowie deren technische Grundlagen zu verwalten.
    \item der Arbeitskreis Landesweite Zusammenarbeit, dessen Vorsitz kraft seines Amtes der Vorsitzende des Studierendenparlamentes übernimmt. Aufgabe ist die Zusammenarbeit mit anderen Studierendenschaften gemäß \href{https://www.landesrecht-bw.de/bsbw/document/jlr-HSchulGBWV26P65}{LHG §65 Abs. (2)}.
  \end{enumerate}

  \item \hl{Arbeitskreise können selbstständig über die ihnen vom STUPA zugewiesenen Mittel verfügen. Ausgaben bedürfen einer sachlichen Prüfung durch den Haushaltsbeauftragen und den Finanzreferenten. Näheres regelt die Finanzordnung entsprechend} \cref{subsec:vermoegen:haushaltsplan-finanzordnung}.

  \item Arbeitskreise haben dem STUPA gegenüber in dessen Sitzungen Bericht zu erstatten. Dies ist Voraussetzung für die selbstständige Verwaltung ihrer Mittel, sowie für Aufwandsentschädigungen, sofern diese durch die GO des STUPA vorgesehen sind.

  \item \hl{Ein Arbeitskreis kann eine Geschäftsordnung beschließen, um ihren Geschäftsgang zu regeln. Sofern ein Arbeitskreis keine Geschäftsordnung beschlossen hat, gilt entsprechend die Geschäftsordnung des Studierendenparlamentes. Der AStA ist über verabschiedete Geschäftsordnungen durch die Arbeitskreisleitung in Kenntnis zu setzen.}
\end{enumerate}
...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item Die übrigen Mitglieder des AStA werden nach der Wahl des Vorsitzenden ebenfalls mit einfacher Mehrheit der Mitglieder des STUPA gewählt. Bei mehreren Kandidaten wird jedes Amt einzeln abgestimmt.
