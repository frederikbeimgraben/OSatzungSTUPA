...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item \hl{Referate können selbstständig über die ihr vom STUPA zugewiesenen Mittel verfügen. Ausgaben bedürfen einer sachlichen Prüfung durch den Haushaltsbeauftragen und den Finanzreferenten. Näheres regelt die Finanzordnung entsprechend} \cref{subsec:vermoegen:haushaltsplan-finanzordnung}.
\end{enumerate}
