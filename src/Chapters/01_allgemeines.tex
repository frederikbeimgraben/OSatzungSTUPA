...
\item Die Mitglieder in den Organen der Studierendenschaft üben ihre Tätigkeit ehrenamtlich aus. \cref{subsec:para:33} Absatz 2 bleibt unberührt.
...
Das Studierendenparlament, der Allgemeine Studierendenausschuss und die Fachschaftsvertretungen regeln ihren Geschäftsgang durch Geschäftsordnungen (GO). Solange eine Fachschaft keine eigene GO beschließt, \hl{gilt entsprechend die GO des StuPa.} % FIXME: CHANGED
