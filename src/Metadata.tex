...
\newcommand{\lastChanged}{19. Februar 2026}
\newcommand{\lastChangedFooter}{Fassung vom 19.02.2026}
\newcommand{\dateWidth}{2cm}
\newcommand{\acceptedUniversity}{\raisebox{-0.05cm}{\TextField[
	print,
	...
	align=1,
	height=0.4cm,
	altname={Vom Präsidium bestätigt am},
...
\AddTitlePageDataLine{Vom STUPA beschlossen am}{\lastChanged}
...
\newcommand{\titlepageabstract}{%
  ...
  Es wurde die Möglichkeit geschaffen, Arbeitskreisleitungen für ihr Engagement zu belohnen.
  Die Rolle der Fachschaften wurde genauer definiert.
  Den Arbeitskreisen und Fachschaften wird eine umfangreichere finanzielle Selbstbestimmung ermöglicht.
